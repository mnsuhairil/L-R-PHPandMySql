...
<link rel="stylesheet" href="jvsc.js">
...
if (isset($_POST['signup'])) {
	...
	if(mysqli_num_rows($query)>0){
		$error = true;
		$email_error="This email already exist in database";
	}
			...
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform">
				<fieldset>
					...
					<div class="form-group">
						...
						<input type="text" name="email" id="search-email" placeholder="Email" required value="<?php if($error) echo $email; ?>" class="form-control" />
